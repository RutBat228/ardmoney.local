...
function prim_zp($fio, $month_name, $year) {
    ...
    $sql = "SELECT 
        uf.dejurstva,  -- Извлекаем dejurstva из user_finance
        u.id as user_id,
        uf.advance,
    ...
    <div class="row g-3">
        <div class="col-9" style="width: 74%;">
            <select class="selectpicker form-control dropup" 
                ...
                style="background: white; height: 2rem;" 
                data-width="100%" 
                data-container="body" 
                title="Редко используемые монтажи" 
                data-hide-disabled="true" 
                data-width="auto" 
                data-live-search="true" 
                name='<?= $vid ?>' 
